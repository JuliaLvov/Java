...
public class ComplexNumbersCalculation extends GeneralNumberDescriptor implements Model<ComplexNumbers>{
    ...
    public ComplexNumbers multiply() {
        return new ComplexNumbers(((getX() * getA()) - (getY() * getB())), ((getY() * getA()) + (getB() * getX())));
    }
